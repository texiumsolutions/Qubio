...
def generate_azure_link(task_id, file_name):
    ...
    base_url = "https://biotex.blob.core.windows.net/proteinfold/outputs/colabdock_output"
...
def run_colabdock(params):
    ...
    output_files = [output_log]  # Add other files from the 'results' folder here if needed
    file_info = []
